...
void taskbar_clock_handler_o (s_window_t *window, s_event_t *event, s_handler_t *handler)
{
	...
	/* W = C + Y + L + M + D (mod 7)
	   ...
	   C is a code for the century from this table (for the Gregorian calendar only):
	   	...
	   	1500s, 1900s, 2300s    ?      ?900 is not a leap year
	   	1600s, 2000s, 2400s    ?      ?000 is a leap year
	   	1700s, 2100s, 2500s    ?      ?100 is not a leap year
	   ...
	   M is the code for the month, from this table:
	   	1. Jan. 0	5. May  1	9.?Sep. 5
	    	2. Feb. 3	6. June?	10. Oct.?
	     	3. Mar. 3	7. July?	11. Nov. 3
	        4. Apr. 6	8. Aug.?	12. Dec. 5
...
void taskbar_clock_draw (s_window_t *window, s_timer_t *timer)
{
	...
	//printf("time %s %d-%d-%d\n",vbuf,t->tm_year,t->tm_mon,t->tm_mday);
	...
	//return ;
		...
		//printf("taskbar_clock_draw got %d \n",__LINE__);
