...
LIBS = -ltiff -ljpeg -lpng -lpng12   -lz -lX11 -ldl -lm 
...
listedit.o lru.o mailto.o main.o menu.o memory.o objreq.o os_dep.o \
pmshell.o png.o sched.o select.o session.o smb.o svgalib.o terminal.o \
tiff.o types.o url.o view.o view_gr.o x11.o xbm.o
#links_DEPENDENCIES =  atheos.o
links_LDFLAGS = 
CFLAGS += -O2 -I../../src/lib -I$(SDKDIR)/xwin/exports/include -DGRDRV_X
...
#	$(LINK) $(links_LDFLAGS) $(links_OBJECTS) $(links_LDADD) $(LIBS)
	$(LD) $(links_LDFLAGS) $(LCFLAG) -o $@ $(CRT1)    $(SERVER_OBJS) $(links_OBJECTS) $(links_LDADD)  -L$(UCLIBBINDIR)  -lX11 -ljpeg -lfreetype -lpng -lz -lgcc $(LINKLIB) 
	$(STRIP)  $@ 
	cp -fr  $@  $(INSTALL_DIR)/bin/
...
framebuffer.o: framebuffer.c cfg.h config.h links.h os_dep.h os_depx.h \
	setup.h language.h codepage.h arrow.inc
...
svgalib.o: svgalib.c cfg.h config.h links.h os_dep.h os_depx.h setup.h \
	language.h codepage.h bits.h arrow.inc
...
xxmaintainer-clean: maintainer-clean-am
	-rm -f config.status
