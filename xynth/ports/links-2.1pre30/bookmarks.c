...
void create_initial_bookmarks(void)
{
	...
	add_bookmark("Netbas OS",NULL,0);
	add_bookmark("Localhost","http://127.0.0.1",1);
	add_bookmark("Uip Webserver","http://192.168.100.2",1);
	add_bookmark("Netbas OS","http://easion.googlepages.com/index.html",1);
	add_bookmark("xynth","http://alperakcan.org/?open=projects&project=xynth",1);
//	add_bookmark("xynth","http://www.xynth.org",1);
	...
	add_bookmark("Kalibraèn?procedura","http://atrey.karlin.mff.cuni.cz/~clock/twibright/links/kalibrace.html",2);
	add_bookmark("Links: domác?stránka","http://atrey.karlin.mff.cuni.cz/~clock/twibright/links/index_cz.html",2);
	add_bookmark("Manuál k Linksu","http://links.twibright.com/user.html",2);


	add_bookmark("Others",NULL,0);
	add_bookmark("Google","http://www.google.com",2);
	add_bookmark("OS DEVELOPMENT","http://www.osdev.org",2);
	add_bookmark("OS News","http://www.osnews.com",2);
	add_bookmark("Linux Devices","http://www.linuxdevices.com",2);
	add_bookmark("OS DEVELOPMENT","http://www.osdev.org",2);
	add_bookmark("Slashdot","http://slashdot.org/",2);
	add_bookmark("Wiki","http://en.wikipedia.org",2);
