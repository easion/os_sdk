...
#define 	DEMO_CHILD     1
#define DEMO_DESKTOP   1
#define DEMO_HIDE      1
#define DEMO_LOAD      1
#define DEMO_SIMPLE    1
#define DEMO_OBJECT    1
#define DEMO_ONSCREENKEYBOARD1
#define DEMO_TEMP      1
#define DEMO_TERM      1
#define DEMO_TIMER     1
#define DEMO_LOGOUT    1
#define DEMO_IMAGE     1
#define DEMO_WIDGETX   1
...
#define DEBUG 1
//#define PIPE_POSIX 1
#define THREAD_PTHREADS 1
#define VIDEO_HELPER_MODES 1
//#define IPC_UDS 1
//#define IPC_TCP 1
