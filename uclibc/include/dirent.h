...
#define readdir netbas_readdir
#define opendir netbas_opendir
#define closedir netbas_closedir
*/
/* This is the data type of directory stream objects.
   The actual structure is opaque to users.  */
#include <netbas/dirent.h>
typedef NETBAS_DIR DIR;
...
# ifndef __USE_FILE_OFFSET64
extern int scandir1 (__const char *__restrict __dir,
		    struct dirent ***__restrict __namelist,
		    int (*__selector) (__const struct dirent *),
		    int (*__cmp) (__const struct dirent **, __const struct dirent **)) __THROW;
# else
#  ifdef __REDIRECT
