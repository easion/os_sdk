...
_PROTOTYPE(int dorm, (struct op *t ));
_PROTOTYPE(int dodir, (struct op *t ));
_PROTOTYPE(int dols, (struct op *t ));
_PROTOTYPE(int docls, (struct op *t ));
_PROTOTYPE(int docwd, (struct op *t ));
_PROTOTYPE(int dodllinfo, (struct op *t ));
_PROTOTYPE(int dolsproc, (struct op *t ));
_PROTOTYPE(int docatproc, (struct op *t ));
_PROTOTYPE(int dowrtproc, (struct op *t ));
_PROTOTYPE(int dops, (struct op *t ));
_PROTOTYPE(int doklog, (struct op *t ));
_PROTOTYPE(int doecho, (struct op *t ));
_PROTOTYPE(int dosleep, (struct op *t ));
_PROTOTYPE(int dokill, (struct op *t ));
_PROTOTYPE(int docat, (struct op *t ));
_PROTOTYPE(int domkdir, (struct op *t ));
_PROTOTYPE(int dormdir, (struct op *t ));
_PROTOTYPE(int domodule, (struct op *t ));
_PROTOTYPE(int doprintenv, (struct op *t ));
_PROTOTYPE(int dotype, (struct op *t ));
_PROTOTYPE(int doinkmod, (struct op *t ));
_PROTOTYPE(int dormkmod, (struct op *t ));
_PROTOTYPE(int dotest, (struct op *t ));
_PROTOTYPE(int douname, (struct op *t ));
_PROTOTYPE(int docp, (struct op *t ));
_PROTOTYPE(int dotouch, (struct op *t ));
