...
#define	LIBDB_SO	"libdb.so.2"
#define	LIBDL_SO	"libdl.so.2"
#define	LIBM_SO	"libm.so.6"
#define	LIBNSL_SO	"libnsl.so.1"
#define	LIBNSS_COMPAT_SO	"libnss_compat.so.1"
#define	LIBNSS_DB_SO	"libnss_db.so.1"
#define	LIBNSS_DNS_SO	"libnss_dns.so.1"
#define	LIBNSS_FILES_SO	"libnss_files.so.1"
#define	LIBNSS_NIS_SO	"libnss_nis.so.1"
